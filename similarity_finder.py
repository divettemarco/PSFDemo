...
class SimilarityFinder:
    def __init__(self, feature_selection=False, directory_path="/Users/andy/Desktop/UTEP/Fall23/Research/similarity_experiment/seeds_reenactments_combined/"):
        ...
        self.dral_clips = self.read_clips('data/dral-demo.csv')
        self.asdnt_clips = self.read_clips('data/asdnt-demo.csv')
        self.swbd_male_clips = self.read_clips('data/swbd-male-demo.csv')
        self.swbd_female_clips = self.read_clips('data/swbd-female-demo.csv')
        ...
        self.times = []
        # creates FeatureExtractor object
    ...
    def find_similar(self, clip_to_find, dataset):
        ...
        third_quartile = round(0.75 * len(cos_similarities_sorted))
        # print('end of find_similar()')
        return cos_similarities_sorted[0], \
            cos_similarities_sorted[1], \
            cos_similarities_sorted[third_quartile], \
            cos_similarities_sorted[-1]
