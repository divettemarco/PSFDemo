...
class FeatureExtractor:
    ...
    def __init__(self, bundle='hubert_l'):
        ...
        self.lengths = []
        print('printing feature extractor info')
        self.print_info()
        # print('done printing feature extractor info')
    ...
    def get_transformation_layers(self, path, plot_layers=False):
        ...
        :return: A list of 12 3d tensors representing the 12 transformation layers
        the audio file passes through.
        Tensor Dimensions:
        1st = number of audio files processed at once
        2nd = number of frames per audio file.
        3rd = number of features extracted per frame.
        """
